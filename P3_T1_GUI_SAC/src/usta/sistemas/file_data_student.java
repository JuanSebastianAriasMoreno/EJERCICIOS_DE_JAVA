            ...
            if (myFile.exists()) {
                ...
                while (myFile2.hasNextLine()) {
                    ...
                    if (separador1 != -1) {  // Garantizamos que la linea de texto tenga datos.
                        ...
                        matrix_students[row][1] = linea_tmp.substring(0, separador2);   // Solo el apellido del estudiante.
                        matrix_students[row][2] = linea_tmp.substring(separador2 + 1);   // Solo la facultad del estudiante.
                        row++;
                    }
                }
                myFile2.close();
